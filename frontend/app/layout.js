...
(function() {
  ...
  // Disabled in dev to avoid controllerchange reload loops during HMR.
  if (window.location.hostname === 'localhost' || /\\.emergentagent\\.com$/.test(window.location.hostname)) {
