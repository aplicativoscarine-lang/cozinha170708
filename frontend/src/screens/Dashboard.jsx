    ...
    courses: [
      {
        ...
        offers: [
          "Mais de 20 receitas de bolos vendedores",
          "Precificação por fatia e por bolo inteiro",
          "Estratégias de encomenda semanal",
          "Apostila em PDF + página de vendas pronta",
        ],
      },
      {
        ...
        offers: [
          "Receitas exclusivas de brigadeiros artesanais",
          "E-book completo + pack de imagens profissionais",
          "Cálculo de custo e margem por unidade",
          "Roteiro de divulgação em redes sociais",
        ],
      },
      {
        ...
        offers: [
          "Iogurtes cremosos, funcionais e proteicos",
          "Cadeia de venda diária + assinatura",
          "Apostila + módulos práticos em vídeo",
          "Bônus de embalagem e apresentação",
        ],
      },
    ],
  },
    ...
    courses: [
      {
        ...
        offers: [
          "Cardápio infantil colorido e vendável",
          "Kits festa e combos personalizados",
          "Contratos e listas de encomenda prontas",
          "Estratégia de parceria com escolas",
        ],
      },
      {
        ...
        offers: [
          "Receitas cremosas de altíssima aceitação",
          "Modelo de produção em lote e revenda",
          "Precificação, rótulos e embalagem",
          "Páginas de venda + criativos prontos",
        ],
      },
      {
        slug: "plr-pascoa",
        ...
        offers: [
          "Ovos de colher, trufados e barras",
          "Calendário de produção e pré-venda",
          "Material 2025 atualizado (VSL + criativos)",
          "Página de vendas pronta para copiar",
        ],
      },
    ],
  },
